...
const POPUP_DATA = {
    0: [ // 1번째 스테이지 (인덱스 0)
        { gif: 'Data/sprites/ui/obj_move.gif', text: '『왼트 Left_Try』에 오신 것을 환영합니다!\n\n해당 버전은 v0.17 테스트 버전입니다.' },
        { gif: 'Data/sprites/ui/pop0_2pp.png', text: '[승리조건]\n\n초록색 플레이어가 노란색 깃발에 닿으면 승리합니다' }
    ],
    1: [ // 2번째 스테이지 (인덱스 1)
        { gif: 'Data/sprites/ui/pop1_2pp.png', text: '빨간색 물체는 당신을 공격하는 적입니다.' },
        { gif: 'Data/sprites/ui/pop1_3pp.png', text: '원거리 공격 물체의 공격 및 인식 범위는 7x7 사이즈입니다.' },
        { gif: 'Data/sprites/ui/pop1_4pp.png', text: '인식 범위 내에 초록색 물체가 들어오면 "인식" 상태가 됩니다.' },
        { gif: 'Data/sprites/ui/pop1_5pp.png', text: '인식 상태 이후 공격 범위 내에 인식된 초록색 물체가 있고, 인식 활성화 시점부터 두 턴 이상 넘어가면 공격을 합니다.' }
    ],
    6: [ // 7번째 스테이지 (인덱스 6)
